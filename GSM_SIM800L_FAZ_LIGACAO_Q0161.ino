...
SoftwareSerial serialGSM(10, 11); // RX--D10, TX---D11
...
#define pinBotaoCall 12 // BOTAO FAZ LIGAÇAO
...
void setup() {
  ...
  pinMode(pinBotaoCall, INPUT_PULLUP); // BOTAO FAZ LIGAÇAO
...
//-BOTAO FAZ LIGAÇAO, VERIFICA SE TEM LIGAÇAO EM CURSO PARA FAZER NOVA LIGAÇAO
  if (!digitalRead(pinBotaoCall) && !callStatus) {
     Serial.println("Afetuando Ligacao..."); 
     fazLigacao(numeroCall);//FAZ LIGAÇAO, PASSANDO O NUMERO DO TELEFONE QUE SERÁ LIGADO.
     callStatus = true;
  }
